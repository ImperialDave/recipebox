      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-8">
        <div className="max-w-7xl mx-auto">
          <section className="mb-10">
            <h1 className="font-serif text-3xl sm:text-4xl font-bold text-fg mb-2">
          ...
          <section className="grid gap-4 sm:grid-cols-3 mb-10">
            <Link href="/recipes/new">
              <div className="flex items-center gap-4 p-5 rounded-2xl bg-accent text-accent-fg hover:bg-accent-hover transition-colors shadow-glow">
                <Plus className="h-8 w-8" />
                <div>
                  <div className="font-semibold text-lg">Add Recipe</div>
                  <div className="text-accent-fg/80 text-sm">
            ...
            <Link href="/recipes">
              <div className="flex items-center gap-4 p-5 rounded-2xl bg-elevated border border-border card-interactive">
                <BookOpen className="h-8 w-8 text-accent" />
                <div>
                  <div className="font-semibold text-lg text-fg">
